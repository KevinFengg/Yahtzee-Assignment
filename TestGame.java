...
public class TestGame {
	...
	public static void main(String[] args) {
		...
		System.out.println(game1.getScoreOptions()[6] + "\n");
		...
		System.out.println("[0, 0, 0, 20, 0, 0, 20, 20, 0, 0, 0, 50, 20]");
		System.out.println(showArray(game1.getScoreOptions()) + "\n");
		...
		System.out.println("[2, 0, 9, 0, 0, 0, 11, 0, 25, 0, 0, 0, 11]");
		System.out.println(showArray(game2.getScoreOptions()) + "\n");
		...
		System.out.println("[0, 0, 3, 4, 10, 6, 0, 0, 0, 30, 0, 0, 23]");
		System.out.println(showArray(game3.getScoreOptions()) + "\n");
		...
		System.out.println(showArray(game3.score()) + "\n");
